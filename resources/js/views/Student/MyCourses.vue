...
<template>
    <div class="space-y-6">
        <h1 class="text-2xl font-bold text-ink-900">{{ $t('dashboard.myCourses') }}</h1>
        ...
        <EmptyState v-else-if="!data.length" icon="book" :title="$t('dashboard.noCoursesYet')" :message="$t('dashboard.browseAndEnroll')">
