 ...
 *
 * Provides the normalised `roles`, `permissions`, `model_has_roles`,
 * `model_has_permissions` and `role_has_permissions` tables without requiring
 * a bespoke role/permission implementation.
 */
